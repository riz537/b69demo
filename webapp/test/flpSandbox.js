		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "b",
									"targetURL": "#comdemob69demo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemob69demo-display": {
								"semanticObject": "comdemob69demo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.b69demo",
									"url": sap.ui.require.toUrl("com/demo/b69demo")
								}
							}
						}
					}
